...
так и с параметром (тег, ссылка или имя без @). 
    ...
    strings = {
        ...
        "sub_required": "👉 Для работы модуля подпишитесь на канал разработчика:",
    ...
    def __init__(self):
        ...
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue("logs_username", "sosoliko2", "Username канала/чата для логов (либо 'me')", validator=loader.validators.Hidden(loader.validators.String())),
